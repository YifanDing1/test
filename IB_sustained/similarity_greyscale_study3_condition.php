...
$idQuerycurr = "SELECT COUNT(*) FROM ProlificParticipants_All WHERE workerID = '$workerID'";

$inelcurr_result = mysqli_query($connection, $idQuerycurr);

$ineligiblecurr = mysqli_fetch_assoc($inelcurr_result);
